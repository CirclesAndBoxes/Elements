...
item replace entity @s armor.chest with leather_chestplate[custom_name='{"bold":false,"color":"red","italic":false,"text":"Fire Robe"}',unbreakable={},fire_resistant={},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:fire_protection":4},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=16711680,trim={material:"minecraft:gold",pattern:"minecraft:wild"},attribute_modifiers=[{type:"generic.armor",name:"generic.armor",amount:8,operation:"add_value",uuid:[I;8346543,-658487922,-646108610,1814900160],slot:"chest"},{type:"generic.armor_toughness",name:"generic.armor_toughness",amount:3,operation:"add_value",uuid:[I;-102050366,-64004580,-100206295,930051714],slot:"chest"}]] 1
item replace entity @s armor.legs with leather_leggings[custom_name='{"bold":false,"color":"red","italic":false,"text":"Fire Greeves"}',unbreakable={},fire_resistant={},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:protection":2},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=16711680,trim={material:"minecraft:gold",pattern:"minecraft:host"}] 1
...
# 6.5 chests armor
# 3 armor toughness
# 4 fire protection, 2 protection, 1 feather falling
