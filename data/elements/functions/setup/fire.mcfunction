...
give @p fire_charge[max_damage=100,custom_name='{"bold":true,"italic":false,"text":"Ability 1"}',damage=0,custom_data={e_slot:2},food={nutrition:1,saturation:0,is_meat:false,can_always_eat:true,eat_seconds:1000000} 1
