...
item replace entity @s armor.head with netherite_helmet[custom_name='{"bold":false,"color":"white","italic":false,"text":"Air Helm"}',unbreakable={},fire_resistant={},enchantments={levels:{"minecraft:binding_curse":1},show_in_tooltip:false},enchantment_glint_override=true,trim={material:"minecraft:quartz",pattern:"minecraft:wayfinder"}] 1
item replace entity @s armor.chest with leather_chestplate[custom_name='{"bold":false,"color":"white","italic":false,"text":"Air Robe"}',unbreakable={},fire_resistant={},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:projectile_protection":1},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=268435455,trim={material:"minecraft:quartz",pattern:"minecraft:vex"}] 1
item replace entity @s armor.legs with leather_leggings[custom_name='{"bold":false,"color":"white","italic":false,"text":"Air Greeves"}',unbreakable={},fire_resistant={},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:protection":1},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=268435455,trim={material:"minecraft:quartz",pattern:"minecraft:spire"}] 1
item replace entity @s armor.feet with leather_boots[custom_name='{"bold":false,"color":"white","italic":false,"text":"Air Boots"}',unbreakable={},fire_resistant={},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:feather_falling":3},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=268435455,trim={material:"minecraft:quartz",pattern:"minecraft:wayfinder"}] 1
