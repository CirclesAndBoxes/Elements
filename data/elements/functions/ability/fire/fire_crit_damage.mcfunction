...
execute as @e[scores={e_FireCrit=25}] at @s run particle flame ~ ~0.5 ~ 0.2 0.2 0.2 0.8 20 normal
...
execute as @e[scores={e_FireCrit=10}] at @s run particle flame ~ ~0.5 ~ 0.2 0.2 0.2 0.8 20 normal
execute as @e[scores={e_FireCrit=10}] at @s run playsound item.firecharge.use player @a

execute as @e[scores={e_FireCrit=1..40}] at @s run particle flame ~ ~0.5 ~ 0.35 0.35 0.35 0.2 1 normal
