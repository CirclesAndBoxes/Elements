...
execute if score @s e_ArrowEscape matches 57 run effect clear @s levitation
execute if score @s[tag=e.inAir,nbt={OnGround:1b}] e_ArrowEscape matches ..57 run function elements:ability/air/arrow_circle
execute if score @s[tag=e.inAir,nbt={OnGround:1b}] e_ArrowEscape matches ..57 run tag @s remove in.Air
execute if score @s e_ArrowEscape matches 1 run function elements:ability/air/arrow_circle