...
execute positioned ^ ^ ^1 positioned ~-.7 ~-.7 ~-.7 as @e[dx=0.4,dy=0.4,dz=0.4,tag=!e.tsunami] positioned ~0.5 ~0.5 ~0.5 run damage @s 0.1 minecraft:out_of_world by @e[type=armor_stand,limit=1,sort=nearest,tag=e.tsunami]
