...
give @s green_dye[custom_name='{"bold":true,"italic":false,"text":"Ability 1"}',custom_data={e_slot:1},food={nutrition:1,saturation:0,can_always_eat:true,eat_seconds:1000000}] 1
give @s firework_star[firework_explosion={shape:"small_ball",colors:[I;3975207]},custom_name='{"bold":true,"italic":false,"text":"Ability 2"}',custom_data={e_slot:2},food={nutrition:2,saturation:0,can_always_eat:true,eat_seconds:1000000}] 1
give @s cobbled_deepslate[custom_name='{"bold":true,"italic":false,"text":"Ability 3"}',custom_data={e_slot:3},food={nutrition:3,saturation:0,can_always_eat:true,eat_seconds:1000000}] 1
