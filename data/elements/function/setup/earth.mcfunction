...
item replace entity @s armor.head with netherite_helmet[custom_name='{"bold":false,"color":"green","italic":false,"text":"Earth Helm"}',unbreakable={},damage_resistant={types:"#is_fire"},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:projectile_protection":2,"minecraft:blast_protection":2},show_in_tooltip:false},enchantment_glint_override=true,trim={material:"minecraft:emerald",pattern:"minecraft:shaper"}] 1
item replace entity @s armor.chest with leather_chestplate[custom_name='{"bold":false,"color":"green","italic":false,"text":"Earth Robe"}',unbreakable={},damage_resistant={types:"#is_fire"},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:fire_protection":1},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=34048,trim={material:"minecraft:emerald",pattern:"minecraft:snout"},attribute_modifiers=[{id:"armor",type:"armor",amount:10,operation:"add_value",slot:"chest"},{type:"armor_toughness",id:"armor_toughness",amount:1,operation:"add_value",slot:"chest"}]] 1
item replace entity @s armor.legs with leather_leggings[custom_name='{"bold":false,"color":"green","italic":false,"text":"Earth Greeves"}',unbreakable={},damage_resistant={types:"#is_fire"},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:protection":6},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=34048,trim={material:"minecraft:emerald",pattern:"minecraft:shaper"}] 1
item replace entity @s armor.feet with leather_boots[custom_name='{"bold":false,"color":"green","italic":false,"text":"Earth Boots"}',unbreakable={},damage_resistant={types:"#is_fire"},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:feather_falling":1},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=34048,trim={material:"minecraft:emerald",pattern:"minecraft:wild"}] 1
...
give @s green_dye[custom_name='{"bold":true,"italic":false,"text":"Ability 1"}',custom_data={e_slot:1},food={nutrition:1,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000}] 1
give @s firework_star[firework_explosion={shape:"small_ball",colors:[I;3975207]},custom_name='{"bold":true,"italic":false,"text":"Ability 2"}',custom_data={e_slot:2},food={nutrition:2,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000}] 1
give @s cobbled_deepslate[custom_name='{"bold":true,"italic":false,"text":"Ability 3"}',custom_data={e_slot:3},food={nutrition:3,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000}] 1
