...
item replace entity @s armor.feet with leather_boots[custom_name='{"bold":false,"color":"red","italic":false,"text":"Water Boots"}',unbreakable={},damage_resistant={types:"#is_fire"},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:feather_falling":1,"minecraft:depth_strider":1},show_in_tooltip:false},enchantment_glint_override=true,dyed_color=2368767,trim={material:"minecraft:diamond",pattern:"minecraft:tide"}] 1
