...
give @s bow[item_name=[{"bold":false,"color":"white","italic":false,"text":"Air Bow"}],unbreakable={},enchantments={infinity:1},enchantment_glint_override=true,attribute_modifiers=[{id:"attack_damage",type:"attack_damage",amount:3,operation:"add_value",slot:"mainhand"},{id:"attack_speed",type:"attack_speed",amount:-2.4,operation:"add_value",slot:"mainhand"}]]

give @s white_dye[item_name=[{"bold":true,"italic":false,"text":"Ability 1"}],custom_data={e_slot:1},food={nutrition:1,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000}] 1

give @s sugar[item_name=[{"bold":true,"italic":false,"text":"Ability 2"}],custom_data={e_slot:2},food={nutrition:2,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000}] 1
give @s feather[item_name=[{"bold":true,"italic":false,"text":"Ability 3"}],custom_data={e_slot:3},food={nutrition:3,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000}] 1
