...
execute as @e[scores={e_FireCrit=40}] at @s run damage @s 8 player_attack by @p[tag=e.fire]
...
execute as @e[scores={e_FireCrit=40}] at @s run playsound entity.firework_rocket.large_blast_far player @a


execute as @e[scores={e_FireCrit=28}] at @s run damage @s 4 on_fire by @p[tag=e.fire]
...
execute as @e[scores={e_FireCrit=16}] at @s run damage @s 6 player_attack by @p[tag=e.fire]
...
execute as @e[scores={e_FireCrit=17..40}] at @s run particle small_flame ~ ~0.5 ~ 0.35 0.35 0.35 0.2 5 normal
